...
class MyDataloader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.modality == 'rgb':
            ...
            sparse_depth = self.create_rgbd(rgb_np, depth_np)
        ...
        sparse_tensor = to_tensor(sparse_depth)
        sparse_tensor = sparse_tensor.unsqueeze(0)

        return [input_tensor, sparse_tensor, depth_tensor]
